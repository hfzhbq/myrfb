...
describe('MyRFB role=server', function () {
    beforeEach( function (done) {
        ...
        this.myRFB = this.MyRFB.create(this.socket, 'server');
    ...
    describe('#handshake(cb)', function () {
        ...
        describe('waterfall tasks', function () {
            ...
            it('should 1) send Version message', function (done) {
            ...
            it('should 2) receive Version message', function (done) {
                var cb = test.sinon.spy();
                this.tasks[1](cb);
            ...
            it('should 3) send the list of security methods supported by server', function (done) {
                var cb = test.sinon.spy();
                this.tasks[2](cb);
            ...
            it('should 4) receive security type message', function (done) {
                var cb = test.sinon.spy();
                this.tasks[3](cb);
            ...
            it('should 6) send security result message', function (done) {
                var cb = test.sinon.spy();
                this.tasks[5](cb);
    ...
    describe('#initialise(cb)', function () {
        ...
        describe('the waterfall tasks', function () {
            ...
            it('should 1) receive ClientInit message', function (done) {
                var cb = test.sinon.spy();
                this.tasks[0](cb);
                expect(this.myRFB.receive).calledOnce
                .and.calledOn(this.myRFB)
            ...
            it('should 2) send ServerInit message', function (done) {
                var cb = test.sinon.spy();
                this.tasks[1](cb);
                expect(this.myRFB.send).calledOnce
                .and.calledOn(this.myRFB)
